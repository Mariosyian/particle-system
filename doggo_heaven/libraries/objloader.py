...
class OBJ:
    ...
    def move_forward(self, lon, eye_x, eye_z):
        glTranslatef(
            eye_x + sin((lon) * DEG_TO_RAD),
            0.0,
            eye_z + cos((lon) * DEG_TO_RAD),
        )

    def move_backward(self, lon, eye_x, eye_z):
        glTranslatef(
            eye_x - sin((lon) * DEG_TO_RAD),
            0.0,
            eye_z - cos((lon) * DEG_TO_RAD),
    ...
    def move_left(self, lon, eye_x, eye_z):
        glTranslatef(
            eye_x + sin((lon + 90.0) * DEG_TO_RAD),
            0.0,
            eye_z + cos((lon + 90.0) * DEG_TO_RAD),
        )

    def move_right(self, lon, eye_x, eye_z):
        glTranslatef(
            eye_x - sin((lon + 90.0) * DEG_TO_RAD),
            0.0,
            eye_z - cos((lon + 90.0) * DEG_TO_RAD),
